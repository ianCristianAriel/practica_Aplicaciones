...
def Leer():
    try:
        ...
        messagebox.showerror('Error', 'No se encuentra la tabla')
...
menu_Borrar.add_command(label='Borrar', command=borrar_Campos)
...
boton_Crear.grid(row=0, column=0)

boton_Leer=Button(frame_Botones, text='Leer', command=Leer)
boton_Leer.grid(row=0, column=1)
